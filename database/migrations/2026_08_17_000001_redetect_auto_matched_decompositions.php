...
return new class extends Migration
{
     ...
     *
     * 注意:
     * - 既に楽曲マスタに紐付いた（song_id が入った）ものは対象外。作られてしまった
     *   アーティスト名が空の楽曲マスタのクリーンアップは Issue #639 で扱う。
     * - 判定は実行時点の TextNormalizer の実装に依存する。判定ロジックが将来
     *   変わると、後から migrate した環境ではこことは違う結果になる。
     */
