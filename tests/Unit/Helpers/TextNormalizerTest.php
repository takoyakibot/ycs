...
class TextNormalizerTest extends TestCase
{
    ...
    public function test_normalize_nfc_combining_dakuten(): void
    {
        ...
        $nfc = "\u{30D9}";         // ベ
        $this->assertEquals('ベ', TextNormalizer::normalize($nfd));
        $this->assertEquals(
    ...
    public function test_normalize_nfc_combining_handakuten(): void
    {
        ...
        $nfc = "\u{30D1}";         // パ
        $this->assertEquals('パ', TextNormalizer::normalize($nfd));
        $this->assertEquals(
            TextNormalizer::normalize($nfc),
            TextNormalizer::normalize($nfd)
        );
    ...
    public function test_normalize_nfc_mixed_text(): void
    {
        ...
        $nfc = 'ベートーヴェン';
        $this->assertEquals('ベートーヴェン', TextNormalizer::normalize($nfd));
        $this->assertEquals(
            TextNormalizer::normalize($nfc),
            TextNormalizer::normalize($nfd)
        );
