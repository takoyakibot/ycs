(function () {
  ...
  const CHAT_ONLY_CONFIG = {
    BUCKET_SEC: 10,
    MIN_CHATS: 10,
    SMOOTH_WINDOW_BUCKETS: 9,
    EMOJI_RATIO_ENTER: 0.25,
    EMOJI_RATIO_EXIT: 0.1,
    EXIT_TOLERANCE_BUCKETS: 6,
    MIN_SEGMENT_SEC: 30,
    MERGE_GAP_SEC: 120,
    MIN_WINDOW_MESSAGES: 2,
  ...
  function ensurePageBridge() { return Promise.resolve(); }
