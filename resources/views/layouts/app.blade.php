...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <!-- Google Analytics -->
        <script async src="https://www.googletagmanager.com/gtag/js?id=G-E0XRQCE7XP"></script>
        <script>
            window.dataLayer = window.dataLayer || [];
            function gtag(){dataLayer.push(arguments);}
            gtag('js', new Date());
            gtag('config', 'G-E0XRQCE7XP');
        </script>
            ...
            <footer class="flex-shrink-0 bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700">
                ...
                <div class="flex items-center justify-between gap-4">
                    <div class="flex flex-shrink-0 gap-x-6 text-sm text-gray-500 dark:text-gray-400">
                        ...
                        <span class="text-gray-400 dark:text-gray-500">&copy; {{ date('Y') }} {{ config('app.name') }}</span>
                    </div>
