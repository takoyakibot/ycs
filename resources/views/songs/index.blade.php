                    ...
                    <div class="p-4 text-gray-900 dark:text-gray-100">
                        ...
                        <div class="flex flex-col gap-2 mb-3 pt-3 border-t border-gray-200 dark:border-gray-700">
                            ...
                            <div id="videoInfoArea" class="flex items-center gap-2">
                                ...
                                <button id="videoLinkBtn" class="px-3 py-1 text-white text-xs rounded flex-shrink-0 flex items-center gap-1 transition-colors bg-gray-400 cursor-not-allowed" disabled aria-label="動画を再生" aria-disabled="true">
                                    ▶ 動画を再生
                                </button>
                            </div>
                        </div>
                        ...
                        <div id="pipPlayerWrapper" class="mt-2 mb-2">
                            ...
                            <div id="pipPlayerContainer" class="hidden rounded-b-lg overflow-hidden shadow-lg border border-t-0 border-gray-200 dark:border-gray-700">
                                ...
                                <div id="pipPlayerControls" class="flex items-center justify-center gap-2 bg-gray-800 px-2 py-1">
                                    <button id="pipPlayerSkipBack" class="text-gray-300 hover:text-white text-xs px-1.5 py-0.5 rounded hover:bg-gray-700 transition-colors" title="10秒戻す">
                                    ...
                                    <button id="pipPlayerSkipForward" class="text-gray-300 hover:text-white text-xs px-1.5 py-0.5 rounded hover:bg-gray-700 transition-colors" title="10秒送る">
                                        <span class="flex items-center gap-0.5">
                                            10秒
        ...
        <div class="bg-white dark:bg-gray-800 p-6 rounded-lg w-full max-w-lg mx-4">
            ...
            <form id="editSongForm" class="space-y-4">
                ...
                <div id="notationCandidatesSection">
                    ...
                    <div id="notationCandidatesList" class="hidden mt-2 max-h-60 overflow-y-auto border border-gray-200 dark:border-gray-600 rounded-md">
                    </div>
                </div>
