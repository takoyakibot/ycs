                        ...
                        <div id="cleanupPanel" class="mb-6 hidden p-4 border-2 border-amber-400 dark:border-amber-500 bg-amber-50 dark:bg-gray-700 rounded">
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <div id="artistCandidatesArea" class="mt-2 hidden">
                                        <div class="text-xs text-gray-500 dark:text-gray-400 mb-1">楽曲マスタの候補:</div>
                                        <div id="artistCandidatesList" class="flex flex-wrap gap-1"></div>
                                    </div>
                                </div>
                            </div>
